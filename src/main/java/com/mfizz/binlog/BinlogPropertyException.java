 ...
 * @author mfizz
 */
public class BinlogPropertyException extends BinlogException {

    /**
     * Constructs an instance of <code>BinlogException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public BinlogPropertyException(String msg) {
        super(msg);
    }
    
    public BinlogPropertyException(String msg, Throwable t) {
        super(msg, t);
    }
}
