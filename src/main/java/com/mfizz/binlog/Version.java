...
public final class Version {
    private static final String TIMESTAMP="20120906-2123";
    private static final String VERSION="2.0.0";
    private static final String NAME="mfz-binlog";
    private static final String VENDOR="com.mfizz";
    private static final String LONG_VERSION="2.0.0 (Build @ 20120906-2123)";
    /** Returns the library vendor such as "com.mfizz" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20120906-2123" */
    static public String getTimestamp() { return TIMESTAMP; }
    /** Returns the library name such as "mfz-binlog" */
    ...
    /** Returns a longer library version that includes the timestamp such as "2.0.0 (Build @ 20120906-2123)" */
